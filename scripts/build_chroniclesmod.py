...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Bun_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Mie_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Pod_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Sza_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Wla_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
...
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
command = ["tools/mmarch.exe", "add", "_tmp/ChroniclesMod_patched/Data/" + "Woj_bmE.lod"] + ["_tmp/ChroniclesMod_patched\Data\\" + "ab.h3c"]
output = subprocess.Popen(command, stdout=subprocess.PIPE).communicate()[0].decode('cp1252')
